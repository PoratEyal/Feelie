...
export const categories: Category[] = [
  {
    ...
    buttons: [
      ...
      { label: "לא יודע", speech: "לֹא יוֹדֵעַ", emoji: "🙄" },
  ...
  },
  {
    ...
    color: "#8b5cf6",
    buttons: [
      { label: "שמח", speech: "שָׂמֵחַ", emoji: "😊" },
      { label: "עצוב", speech: "עָצוּב", emoji: "😢" },
      { label: "כועס", speech: "כּוֹעֵס", emoji: "😠" },
      { label: "מפחד", speech: "מְפַחֵד", emoji: "😨" },
      { label: "עייף", speech: "עָיֵף", emoji: "😴" },
      { label: "רגוע", speech: "רָגוּעַ", emoji: "😌" },
      { label: "מבולבל", speech: "מְבֻלְבָּל", emoji: "😕" },
      { label: "נרגש", speech: "נִרְגָּשׁ", emoji: "🤩" },
      { label: "מודאג", speech: "מוֹדָאָג", emoji: "😟" },
      { label: "מתבייש", speech: "מִתְבַּיֵּשׁ", emoji: "😳" },
      { label: "משועמם", speech: "מְשֻׁעֲמָם", emoji: "😑" },
    ],
  },
  {
    id: "needs",
  ...
  },
  {
    ...
    buttons: [
      ...
      { label: "תכבה אור", speech: "תְּכַבֶּה אוֹר", emoji: "💡" },
      { label: "אני רוצה לבד", speech: "אֲנִי רוֹצֶה לְבַד", emoji: "🧘" },
      { label: "תעצור", speech: "תַּעֲצוֹר", emoji: "🛑" },
  ...
  },
  {
    ...
    buttons: [
      ...
      { label: "רוצה לשחק", speech: "רוֹצֶה לְשַׂחֵק", emoji: "🎮" },
      { label: "תורי", speech: "תּוֹרִי", emoji: "☝️" },
      { label: "תחכה", speech: "תְּחַכֶּה", emoji: "🤚" },
    ],
  },
  {
    id: "activities",
  ...
  },
  {
    ...
    buttons: [
      ...
      { label: "עוד אחד", speech: "עוֹד אֶחָד", emoji: "☝️" },
